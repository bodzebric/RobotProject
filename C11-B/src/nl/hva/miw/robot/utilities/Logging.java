...
/**
 * Custom logging class. Configures log system (not console) to write to a disk
 * file.
 */
public class Logging {
	...
	/**
	 * Used by other classes to implement logging. Other classes should log with
	 * methods on this object or the simpler methods of this class. The methods in
	 * this class will record the location in your program where you call them.
	 */
	public final static Logger logger = Logger.getGlobal();

	// The log file can be copied from the ZTE robot controller to your PC for
	// review by using the
	...
	/**
	 * Configures our custom logging. If you don't use this custom logging, logging
	 * will go to the default logging location, typically the console. Call setup to
	 * turn on custom logging. With custom logging turned on logging goes to the
	 * console and also to the file opened in setup().
	 */
	 ...
	 *            The package name of class calling setup(). Use
	 *            classname.class.getPackage() instead of hardcoding the package
	 *            name.
	 * @param logToConsole
	 *            Determines if logging goes to the console as well as the file.
	 *            Logging to the console, which is the EV3 LCD, does work well.
	 * @throws IOException
	 */
